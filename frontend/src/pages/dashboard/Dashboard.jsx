    ...
    <>
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                <div className="overflow-y-auto" style={{maxHeight: '24rem'}}>
                  <ul className="p-6 space-y-6">
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Fufi Badmosh</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Ramesh babu</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Kallu Bhai</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Joe Root</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">RupaDevi</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Sunny deol</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Ram Babu</span>
            ...
            <section className="text-right font-semibold text-gray-500">
              <a href="#" className="text-purple-600 hover:underline">Recreated on VScode</a> with <a href="https://tailwindcss.com/" className="text-teal-400 hover:underline">Tailwind CSS</a> by syed irshad (Mr.SidSir), <a href="https://dribbble.com/shots/10711741-Free-UI-Kit-for-Figma-Online-Courses-Dashboard" className="text-purple-600 hover:underline">original design</a> Syed Irshad
            </section>
    </>
  )
}
